...
set GLM_BUILD_TEST = -DGLM_TEST_ENABLE=OFF
set GLM_BUILD_LIBRARY = -DBUILD_LIBRARY=ON
set GLM_ENABLE_CXX_20 = -DGLM_ENABLE_CXX_20=ON
...
cmake -A Win32 -DCMAKE_CONFIGURATION_TYPES="Debug;Release" ^
    ...
    %GLM_BUILD_TEST% %GLM_BUILD_LIBRARY% %GLM_ENABLE_CXX_20% ..
if %errorlevel% neq 0 (
